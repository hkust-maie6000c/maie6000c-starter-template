...
class Case(Base):
    ...
    status: Mapped[str] = mapped_column(String(20), nullable=False, default=CaseStatus.NEW.value, index=True)
...
class Job(Base):
    ...
    job_type: Mapped[str] = mapped_column(String(50), nullable=False, default=JobType.TRIAGE_CASE.value)
